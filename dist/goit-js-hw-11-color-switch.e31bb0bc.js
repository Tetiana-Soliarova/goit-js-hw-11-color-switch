...
var buttonStart = document.querySelector('button[data-action="start"]'); //console.log(buttonStart);

buttonStart.addEventListener('click', onButtonStartClick);
var buttonStop = document.querySelector('button[data-action="stop"]'); //console.log(buttonStop);
